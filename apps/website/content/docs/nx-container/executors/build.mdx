...
<AutoTypeTable path="../../plugins/nx-container/src/executors/build/schema.d.ts" name="BuildExecutorSchema" />

#### Metadata

<AutoTypeTable path="../../plugins/nx-container/src/executors/build/schema.d.ts" name="Metadata" />
