...
- The engine, as the container engine you want to use (docker, podman, or kaniko).
- The template, as the dockerfile template you want to use (empty, nest, next, nginx).


### Options:

<AutoTypeTable path="../../plugins/nx-container/src/generators/configuration/schema.d.ts" name="ConfigurationGeneratorSchema" />
