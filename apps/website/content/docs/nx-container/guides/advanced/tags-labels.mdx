...
for labels, you can do it in a dedicated setup step. The following workflow will use the [container-metadata package](https://github.com/gperdomor/oss/tree/main/packages/container-metadata)
