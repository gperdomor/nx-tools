import { ContextProxyFactory, RepoMetadata, RepoProxyFactory } from '@nx-tools/ci-context';
...
const tagsLabelsTest = async (
  ...
  const meta = new Meta({ ...getInputs({}), ...inputs }, await ContextProxyFactory.create(), repo, logger);
