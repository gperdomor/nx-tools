...
/**
 * Builds an image using instructions from the Dockerfile and a specified build context directory.
 */
export interface DockerBuildExecutor {
  engine?: string;
  quiet?: boolean;
  /**
  ...
  registry?: string;
  /**
   * List of secrets to expose to the build (eg. key=string, GIT_AUTH_TOKEN=mytoken, NPM_TOKEN=${NPM_TOKEN})
   */
  secrets?: string[];
  /**
